# Generated by Django 5.0.1 on 2024-04-01 04:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.PositiveIntegerField(help_text='Enter the Price of the Apartment.', validators=[django.core.validators.MinValueValidator(1)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees', models.JSONField(blank=True, default=api.models.lease_details.default_fees, help_text='JSON field to store various fees associated with the lease.', null=True)),
                ('discounts', models.JSONField(blank=True, default=api.models.lease_details.default_discounts, help_text='JSON field to store various discounts associated with the lease.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parking_fee', models.DecimalField(decimal_places=2, help_text='Fee associated with the parking space.', max_digits=10, validators=[django.core.validators.MinValueValidator(0.0)])),
                ('apartment_number', models.ForeignKey(help_text='Apartment associated with the parking space.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='parking_spaces', to='api.apartmentdetails')),
